<div>
    ...
    <div class="max-w-4xl space-y-6">
        ...
        <x-panel eyebrow="Context" title="Reference images" glyph="❖">
            <p class="text-ink-soft text-sm mb-3">Add images (logo, product, examples) and say what they are. IATECA uses the descriptions when writing and the images as a visual reference when generating the cards.</p>
                        ...
                        <div class="flex gap-3 items-start border border-ink-soft/15 rounded-sm p-2 bg-vellum/30" wire:key="ref-{{ $r }}">
                            ...
                            <div class="flex-1 min-w-0">
                                <input type="text" wire:model.blur="referencias.{{ $r }}.descricao"
                                       placeholder="what it is: «IATECA logo», «product photo»…"
        ...
        <x-panel eyebrow="Assistant" title="Write with AI" glyph="✶">
            <p class="text-ink-soft text-sm mb-3">Describe the topic; IATECA composes the {{ $this->kind['formato'] === 'carousel' ? 'carousel' : 'text' }}.</p>
