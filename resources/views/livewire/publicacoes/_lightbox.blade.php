{{-- Fullscreen viewer. Opens with the window event «abrir-lightbox»
     ({ imgs: [urls], i: startIndex }); navigate with the arrows / keyboard. --}}
...
<div x-data="{
    ...
    <button x-show="i < imgs.length - 1" @click.stop="prox()" title="Next (→)"
