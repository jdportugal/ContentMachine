@props(['glyph' => '❦', 'title' => 'Chapter yet to be written', 'note' => null])
...
<div class="frame-engraved foxing bg-vellum/40 rounded-sm py-20 px-8 text-center">
    ...
    @endif
    <div class="mt-6 font-mono text-[0.62rem] text-ink-faint tracking-widest uppercase">In preparation · Nota bene</div>
</div>
