---
titulo: 'Cerebras Killed Notion, Obsidian, and Your "Second Brain"'
tipo: item_agregado
plataforma: youtube
canal: 'Nick Saraev'
data: '2026-07-19'
...
resumo: 'O vídeo aborda como construir uma base de conhecimento empresarial baseada em IA usando RAG (retrieval-augmented generation), inspirada na abordagem da Cerebras, que ingere dados de fontes como Slack, Confluence, GitHub e bases de dados para permitir consultar informação da organização. O autor explica o conceito e demonstra como construir um sistema destes passo a passo.'
tags:
  - automation
  - 'content creation'
  - 'ai content'
