---
titulo: 'I Gave GPT-5.6-Sol Unlimited Money to Make Ads (+ Results)'
tipo: item_agregado
plataforma: youtube
canal: 'Nick Saraev'
data: '2026-07-12'
url: 'https://www.youtube.com/watch?v=rbUFFMtKcaQ'
thumbnail: 'https://i.ytimg.com/vi/rbUFFMtKcaQ/maxresdefault.jpg'
descricao: "🔥 Join Maker School & get customer #1 guaranteed: https://skool.com/makerschool/about 💎 Get the full setup + instructions here free: https://skool.com/maker-zero/about ➡️ Higgsfield (image + video modes) here: https://higgsfield.ai/s/jVuTBV ➡️ If this is your first video: I'm Nick Saraev. I run LeftClick, an AI growth consultancy. We've done work for large brands you're likely familiar with, like Mr. Beast, Anthropic, OpenAI, and a few others. In plain English: I help people build systems that generate leads, close deals, and scale businesses, mostly using new AI models like Claude. I also make videos about how to do all of that here on YouTube. It hasn't always been this way. My family immigrated from a Soviet bloc country (People's Republic of Bulgaria) in the 90s. They worked extremel..."
resumo: 'O vídeo testa a capacidade do modelo GPT-5.6-Sol para gerar produtos e campanhas de marketing de forma autónoma, criando mais de 80 produtos com anúncios em imagem e vídeo através de IA. Mostra vários exemplos de produtos concebidos (tapetes, incenso, suportes para portáteis, organizadores de cabos, etc.) e explica como replicar todo o processo, incluindo os prompts usados.'
tags:
  - automation
  - 'content creation'
  - 'ai content'
...
💎 Get the full setup + instructions here free: https://skool.com/maker-zero/about
➡️ Higgsfield (image + video modes) here: https://higgsfield.ai/s/jVuTBV
...
Summary ⤵️
I built an autonomous product generator using GPT-5.6-Sol, Higgsfield, and Netlify.

In this video, I give it to you all completely free. The engine produces completely autonomous ads and is pretty darn tootin' cool if I do say so myself.

--

Chapters ⤵️
0:00 I Let GPT-5.6 Sol Run a Product Business
1:03 Touring the 80+ Generated Products
3:00 The Core Idea: Let the Model Prompt Itself
5:03 The 4-Step Pipeline
5:28 The Platforms You Need
6:10 Setup: Codex CLI + GPT-5.6 Sol
8:13 Setup: Higgsfield MCP
11:28 Setup: Netlify Hosting
12:30 The Master Prompt, Line by Line
14:39 Parallelize Everything
15:35 Launching the Engine
16:20 Watching It Generate Live
19:05 Get Everything Free
