---
titulo: 'Perception Agents — Antje Barth, Amazon AGI Lab'
tipo: item_agregado
plataforma: youtube
canal: 'AI Engineer'
data: '2026-07-23'
url: 'https://www.youtube.com/watch?v=2JX6JYyQG4Y'
thumbnail: 'https://i.ytimg.com/vi/2JX6JYyQG4Y/maxresdefault.jpg'
descricao: "Human-agent collaboration is changing, becoming more visual. The agents most teams ship today still wait for us to type a paragraph to explain what we're looking at. They cannot see a screen, navigate a UI that changes, or recover when an application throws an unexpected modal. That is the architectural gap between agents that demo well and agents that work alongside real teams in real software. Perception agents close it: they see and use computers the way people do, reason about what they see, and act with clicks and keystrokes. Speaker: Antje Barth — Member of Technical Staff, Amazon AGI Lab Antje is an AI product leader, keynote speaker, O'Reilly author, and co-instructor of Generative AI with Large Language Models with DeepLearning.AI. X/Twitter: https://x.com/anbarth Timestamps 0:00..."
resumo: 'Este vídeo aborda o desafio da fiabilidade em agentes de IA: apesar de já conseguirem executar passos individuais (clicar, escrever, chamar APIs) e operar fluxos de trabalho, os agentes ainda falham em concluir processos completos de ponta a ponta porque o trabalho real vive nas ligações entre diferentes sistemas e aplicações. Discute-se a distinção entre adicionar capacidades aos modelos e alcanç...'
tags:
  - ai
  - 'ai engineer'
  - 'ai engineering'
...
technical staff at Amazon AGI lab
[music] onjab. bar.
...
doing work in an end toend workflow.
...
reliability and trust and this is coding
right. Think about how fast coding
evolved.
...
basis.
And nobody really has corrected this
part yet.
...
worked out.
A perception agent can read the rendered
screen so it can confirm its own output
instead of just firing off those actions
and then hoping.
...
there marking the section. And maybe you
want to change it. Why not? Let's change
it to red.
...
And then we have this design meeting and
I had a couple of great ideas how to
...
this would have liked like you did some
...
yellow or you take an action and say,
"No, um fix this violation."
...
GitHub repos, open source. Tell us what
we're missing. give us the feedback what
you would like to see where this should
go next because ultimately none of us
get smart alone and that's the whole
point. We want to build AI that makes
all of us smarter together.
...
You can find the podcast on on any
popular podcast platform.
We also have more sessions this week.
Um, so check them out. We have a booth
down there. We have expert talks. We
also have another computer use track
talk coming up with my colleague Gaf
Mishra at 1:30 in the computer use
track. Highly recommend checking out his
talk from RL to IRL.
