...
resumo: 'O vídeo mostra como o autor usou o Claude Code para transformar anos de histórico de conversas do ChatGPT e do Claude num sistema de memória em forma de grafo de conhecimento, funcionando como um "segundo cérebro" digital. Explica como construir esse cérebro principal, criar sub-cérebros focados em projetos específicos e usar agentes de IA para navegar pelas ligações e recuperar apenas o contexto...'
tags: {}
fontes:
