...
resumo: 'O vídeo explica porque é que os modelos de IA como o Claude, o ChatGPT e o Gemini tendem a concordar demasiado com o utilizador (devido ao treino por RLHF) e mostra como usar um "conselho" de vários agentes de IA, cada um com uma persona independente, para analisar uma questão de ângulos diferentes e obter conselhos menos enviesados. Ensina ainda a montar e personalizar esse conselho como um paine...'
tags: {}
fontes:
