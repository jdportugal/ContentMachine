---
titulo: "I'm changing how I invest my money because of AI"
tipo: item_agregado
plataforma: youtube
canal: 'Dan Martell'
data: '2026-07-09'
url: 'https://www.youtube.com/watch?v=b6aLGChngnE'
thumbnail: 'https://i.ytimg.com/vi/b6aLGChngnE/maxresdefault.jpg'
descricao: "✅ Get my FREE AI Operating System here: https://go.danmartell.com/4wDfgpn 👥 Are you building an AI software company? Partner with me: https://go.danmartell.com/3QKtcPb Most people are still investing the way their parents did, and it's why they're leaving massive returns on the table. I've spent decades putting real money into startups, real estate, and public companies, and AI has completely rewired how I make every single decision. In this video, I break down the exact way I'm using AI to find opportunities other investors miss, pressure-test every deal before I fund it, and monitor everything I own in one place. Stay till the end because the final principle is the one that separates people who build wealth from people who lose it. Prompts from the video: Spot investments others won't:..."
resumo: 'O vídeo mostra como usar ferramentas de IA (como Claude, Gemini ou ChatGPT) para tomar decisões de investimento, defendendo a criação de riqueza em vez da sua preservação. O apresentador partilha o seu método para identificar oportunidades pouco óbvias — efeitos de segunda e terceira ordem, análise de tendências e imobiliário — através de prompts concretos dados a um modelo de linguagem.'
tags:
  - AI
  - Investing
  - 'personal finance'
fontes:
  - 'https://go.danmartell.com/4wDfgpn'
  - 'https://go.danmartell.com/3QKtcPb'
...
✅ Get my FREE AI Operating System here: https://go.danmartell.com/4wDfgpn

👥 Are you building an AI software company? Partner with me: https://go.danmartell.com/3QKtcPb

Most people are still investing the way their parents did, and it's why they're leaving massive returns on the table.

I've spent decades putting real money into startups, real estate, and public companies, and AI has completely rewired how I make every single decision. In this video, I break down the exact way I'm using AI to find opportunities other investors miss, pressure-test every deal before I fund it, and monitor everything I own in one place. Stay till the end because the final principle is the one that separates people who build wealth from people who lose it.

Prompts from the video:

Spot investments others won't:
Prompt 1:
...
Prompt 2:
"Now run an analysis of recent trends and market signals around those names. Show me the second and third-degree winners and losers that could be real opportunities."


Red team every investment before you fund it:
...
Build a live monitoring dashboard for everything you own:
"Build me a live dashboard that tracks [paste your list]. For each one, show me what 'healthy,' 'caution,' and 'unhealthy' looks like based on price movement, market trends, and key signals. Flag anything I should look at."
